...
This module contains all the prompts used by the deep research agent,
organized by their purpose. Prompts are designed to be modular and
configurable with placeholder substitution.

Prompts are inspired by patterns from open_deep_research but adapted
...
# Compression instruction message
...
# Think tool prompt
THINK_TOOL_PROMPT = """You are a research assistant thinking through a problem.
Reflect on your reasoning and plan your next steps.
...
4. Are there any issues with my current approach?

Provide a brief, focused reflection on your thinking process.
"""
...
def format_clarify_prompt(messages: str) -> str:
    """Format the clarification prompt with messages.
...
def format_research_brief_prompt(messages: str) -> str:
    """Format the research brief prompt with messages.
...
def format_final_report_prompt(
    research_brief: str,
    messages: str,
    findings: str,
) -> str:
    """Format the final report prompt.
